...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <div class="breadcrumb greenContainer">
            <a href="Usuario.aspx" class="whiteText">Registro</a>
           
        </div>
        <div>
            
            <asp:button href="Usuario.aspx" text="Nuevo" runat="server"  CssClass="btn btn-info btn-fill btn-wd boton-registro" />
