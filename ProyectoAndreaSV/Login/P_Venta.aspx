        ...
        <asp:Panel ID="PanelVenta" runat="server">
            ...
            <asp:Panel ID="pnlListadoVenta" runat="server" Direction="LeftToRight" Width="1077px" BackColor="#FFFFCC">
                ...
                <asp:DropDownList ID="DropDownListVenta" runat="server" AppendDataBoundItems="true">
                    ...
                    <asp:ListItem Value="clienteId" Selected="True">Cliente</asp:ListItem>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:default %>" SelectCommand="SELECT * FROM [tbl_Ventas]"></asp:SqlDataSource>
